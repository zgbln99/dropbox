...
const en = {
  ...
  statStorageHistory: 'Storage usage over time',
  statTopDownloads: 'Most downloaded',
  statsCollecting: 'Not enough data yet — the chart fills in as you use the app.',
  statsNoDownloads: 'No downloads recorded yet.',
...
const pl: Record<Key, string> = {
  ...
  statTotalDownloads: 'Łącznie pobrań',
  statStorageHistory: 'Wykorzystanie miejsca w czasie',
  statTopDownloads: 'Najczęściej pobierane',
  statsCollecting: 'Za mało danych — wykres wypełni się w miarę korzystania z aplikacji.',
  statsNoDownloads: 'Nie zarejestrowano jeszcze żadnych pobrań.',
  downloadsCount: 'pobrań: {n}',
  prevFile: 'Poprzedni',
  nextFile: 'Następny',
